...
Automatic approval reviews recorded by Codex as `codex-auto-review` appear under **Auditors**, retaining that model label. Other task subagents, including Snipe reviews using Sol, remain under **Task subagents**. Auditor tokens remain included in overall totals but are excluded from the task-subagent subtotal.
